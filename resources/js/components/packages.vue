<template>
    ...
    <div class="table_container packages">
...
<!--                    </div>-->
        ...
        <span class="table-meta-info">There are total <strong>{{ total  }}</strong> Packages</span>
        <table>
            <thead>
            <tr>
<!--                <th>id</th>-->
...
<!--                <td>  {{pkg.id}}</td>-->
                <td> <strong>Name: </strong> <span>{{pkg.name}}</span> </td>
                <td><strong>Bandwidth: </strong> <span> {{pkg.bandwidth}}</span></td>
                <td><strong>Fees: </strong> <span> {{pkg.fees}}</span></td>
                <td class="neutral connections"><strong>Connections: </strong> <span> {{pkg.connections_count}}</span></td>
                <td class="icons-container"><a :href="'/connections?pkg='+pkg.name">
                    ...
                    <a :href="'packages/'+ pkg.id +'/delete'" v-if="pkg.connections_count === 0" >
                    ...
                    <a :href="'packages/'+ pkg.id +'/edit'" v-if="pkg.connections_count === 0" >
